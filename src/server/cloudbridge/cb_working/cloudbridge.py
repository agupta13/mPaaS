...
class ThreadedTCPRequestHandler_mc(SocketServer.BaseRequestHandler):
    ...
    def handle(self):
        ...
        for i in range(0,len(ports)):
            HOST, PORT = "152.14.93.234",ports[i]
...
class ThreadedTCPRequestHandler_cp(SocketServer.BaseRequestHandler):
    ...
    def handle(self):
        ...
        portd = InstructionHandling.queueOps(instr, priority)
        print "Start server over the port:",portd
        
        HOST, PORT = "152.14.93.234",portd
