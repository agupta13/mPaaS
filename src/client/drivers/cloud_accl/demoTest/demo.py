...
file1="/sys/devices/platform/cloudaccl/sax"
file2="/sys/devices/platform/cloudaccl/say"
file3="/sys/devices/platform/cloudaccl/saz"

class DataGens(object):

    def __init__(self, axis,init):
...
class GraphFrame(wx.Frame):
    ...
    def __init__(self):
        ...
        self.datagen1 = DataGens(1,0)
        self.datagen2 = DataGens(2,0)
        self.datagen3 = DataGens(3,0)
        self.data1 = [self.datagen1.next()]
        self.data2 = [self.datagen2.next()]
        self.data3 = [self.datagen3.next()]
        self.paused = False
    ...
    def on_redraw_timer(self, event):
        ...
        #
        if not self.paused:
            self.data1.append(self.datagen1.next())
            self.data2.append(self.datagen2.next())
            self.data3.append(self.datagen3.next())
    ...
    def flash_status_message(self, msg, flash_len_ms=4000):
